...
class EasySimulator(Simulator):
    ...
    def setup_world(self,
        ...
        print(
            f"🟢 Easy Mode: {self.width}x{self.height} grid, {len(obstacle_positions)} obstacles, {len(item_positions)} items")
...
class MediumSimulator(Simulator):
    ...
    def setup_world(self,
        ...
        print(
            f"🟡 Medium Mode: {self.width}x{self.height} grid, {len(obstacle_positions)} obstacles, {len(item_positions)} items")
...
class HardSimulator(Simulator):
    ...
    def setup_world(self,
        ...
        print(
            f"🔴 Hard Mode: {self.width}x{self.height} grid, {len(obstacle_positions)} obstacles, {len(item_positions)} items")
